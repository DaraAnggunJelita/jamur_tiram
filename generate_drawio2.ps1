...
<mxfile host="app.diagrams.net">
  <diagram id="alur_sistem" name="Alur Sistem Produksi Jamur Tiram">
    <mxGraphModel dx="1000" dy="1000" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1500" pageHeight="2200" math="0" shadow="1">
      <root>
        <mxCell id="0"/>
        ...
        <mxCell id="lane3" value="Sistem Aplikasi &amp; Database" style="swimlane;whiteSpace=wrap;html=1;fillColor=#10B981;fontColor=#ffffff;fontStyle=1;startSize=30;" vertex="1" parent="1">
          <mxGeometry x="640" y="40" width="400" height="2100" as="geometry"/>
        </mxCell>
        <mxCell id="lane4" value="Pengguna Umum (Pelanggan)" style="swimlane;whiteSpace=wrap;html=1;fillColor=#F59E0B;fontColor=#ffffff;fontStyle=1;startSize=30;" vertex="1" parent="1">
          <mxGeometry x="1040" y="40" width="300" height="2100" as="geometry"/>
        </mxCell>
        ...
        <mxCell id="n3" value="Simpan Data Bibit" style="shape=cylinder3;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;size=15;fillColor=#cce5ff;strokeColor=#007bff;" vertex="1" parent="1"><mxGeometry x="880" y="190" width="100" height="70" as="geometry"/></mxCell>
        ...
        <mxCell id="n6" value="Stok Bibit&#10;Cukup?" style="rhombus;whiteSpace=wrap;html=1;fillColor=#fff3cd;strokeColor=#ffc107;fontStyle=1;" vertex="1" parent="1"><mxGeometry x="700" y="365" width="120" height="80" as="geometry"/></mxCell>
        <mxCell id="n7" value="Notifikasi Stok Habis" style="ellipse;whiteSpace=wrap;html=1;fillColor=#f8d7da;strokeColor=#dc3545;fontStyle=1;strokeWidth=2;" vertex="1" parent="1"><mxGeometry x="880" y="380" width="100" height="50" as="geometry"/></mxCell>
        <mxCell id="n8" value="Kurangi Stok &amp; Simpan Baglog" style="shape=cylinder3;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;size=15;fillColor=#cce5ff;strokeColor=#007bff;" vertex="1" parent="1"><mxGeometry x="865" y="480" width="130" height="70" as="geometry"/></mxCell>
        ...
        <mxCell id="n11" value="Suhu &gt;= 95°C&#10;&amp; Durasi &gt;= 8 Jam?" style="rhombus;whiteSpace=wrap;html=1;fillColor=#fff3cd;strokeColor=#ffc107;fontStyle=1;" vertex="1" parent="1"><mxGeometry x="685" y="645" width="150" height="80" as="geometry"/></mxCell>
        <mxCell id="n12" value="Status Beresiko" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#e2e8f0;strokeColor=#64748b;" vertex="1" parent="1"><mxGeometry x="710" y="780" width="100" height="50" as="geometry"/></mxCell>
        ...
        <mxCell id="n14" value="Simpan Status Aman" style="shape=cylinder3;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;size=15;fillColor=#cce5ff;strokeColor=#007bff;" vertex="1" parent="1"><mxGeometry x="870" y="650" width="120" height="70" as="geometry"/></mxCell>
        ...
        <mxCell id="n16" value="Cek Masa Pendinginan&#10;(&gt; 24 Jam?)" style="rhombus;whiteSpace=wrap;html=1;fillColor=#fff3cd;strokeColor=#ffc107;fontStyle=1;" vertex="1" parent="1"><mxGeometry x="685" y="885" width="150" height="80" as="geometry"/></mxCell>
        <mxCell id="n17" value="Tolak Input (Masih Panas)" style="ellipse;whiteSpace=wrap;html=1;fillColor=#f8d7da;strokeColor=#dc3545;fontStyle=1;strokeWidth=2;" vertex="1" parent="1"><mxGeometry x="870" y="900" width="120" height="50" as="geometry"/></mxCell>
        <mxCell id="n18" value="Simpan Inokulasi" style="shape=cylinder3;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;size=15;fillColor=#cce5ff;strokeColor=#007bff;" vertex="1" parent="1"><mxGeometry x="870" y="1000" width="120" height="70" as="geometry"/></mxCell>
        ...
        <mxCell id="n21" value="Miselium&#10;100%?" style="rhombus;whiteSpace=wrap;html=1;fillColor=#fff3cd;strokeColor=#ffc107;fontStyle=1;" vertex="1" parent="1"><mxGeometry x="710" y="1185" width="100" height="80" as="geometry"/></mxCell>
        <mxCell id="n22" value="Simpan Log Biasa" style="shape=cylinder3;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;size=15;fillColor=#cce5ff;strokeColor=#007bff;" vertex="1" parent="1"><mxGeometry x="870" y="1190" width="120" height="70" as="geometry"/></mxCell>
        <mxCell id="n23" value="Buka Kapas&#10;(Siap Panen)" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#e2e8f0;strokeColor=#64748b;" vertex="1" parent="1"><mxGeometry x="700" y="1300" width="120" height="50" as="geometry"/></mxCell>
        <mxCell id="n24" value="Simpan Status" style="shape=cylinder3;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;size=15;fillColor=#cce5ff;strokeColor=#007bff;" vertex="1" parent="1"><mxGeometry x="880" y="1290" width="100" height="70" as="geometry"/></mxCell>
        ...
        <mxCell id="n27" value="Simpan Laporan&#10;(Status Pending)" style="shape=cylinder3;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;size=15;fillColor=#cce5ff;strokeColor=#007bff;" vertex="1" parent="1"><mxGeometry x="870" y="1475" width="120" height="70" as="geometry"/></mxCell>
        ...
        <mxCell id="n30" value="Status Dibatalkan" style="shape=cylinder3;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;size=15;fillColor=#cce5ff;strokeColor=#007bff;" vertex="1" parent="1"><mxGeometry x="880" y="1590" width="100" height="70" as="geometry"/></mxCell>
        <mxCell id="n31" value="Status Valid &amp;&#10;Update Stok" style="shape=cylinder3;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;size=15;fillColor=#cce5ff;strokeColor=#007bff;" vertex="1" parent="1"><mxGeometry x="870" y="1690" width="120" height="70" as="geometry"/></mxCell>
        
        <mxCell id="n32" value="Sudah 5x&#10;Panen?" style="rhombus;whiteSpace=wrap;html=1;fillColor=#fff3cd;strokeColor=#ffc107;fontStyle=1;" vertex="1" parent="1"><mxGeometry x="710" y="1685" width="100" height="80" as="geometry"/></mxCell>
        <mxCell id="n33" value="Tandai Afkir&#10;(Selesai)" style="ellipse;whiteSpace=wrap;html=1;fillColor=#f8d7da;strokeColor=#dc3545;fontStyle=1;strokeWidth=2;" vertex="1" parent="1"><mxGeometry x="710" y="1820" width="100" height="50" as="geometry"/></mxCell>

        <!-- UMUM NODES -->
        <mxCell id="u1" value="Melihat Katalog &amp;&#10;Ketersediaan Jamur" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#fef3c7;strokeColor=#d97706;" vertex="1" parent="1"><mxGeometry x="1115" y="1690" width="150" height="70" as="geometry"/></mxCell>
        <mxCell id="u2" value="Pemesanan Jamur&#10;(via WhatsApp)" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#fef3c7;strokeColor=#d97706;" vertex="1" parent="1"><mxGeometry x="1115" y="1800" width="150" height="70" as="geometry"/></mxCell>
        ...
        <mxCell id="e106" value="Ya (Tersedia)" style="edgeStyle=orthogonalEdgeStyle;rounded=1;html=1;strokeColor=#333333;strokeWidth=2;fontStyle=1;fontSize=11;" edge="1" parent="1" source="n6" target="n8"><mxGeometry relative="1" as="geometry"><Array as="points"><mxPoint x="930" y="405" /></Array></mxGeometry></mxCell>
        ...
        <mxCell id="e114" value="Lanjut Inokulasi" style="edgeStyle=orthogonalEdgeStyle;rounded=1;html=1;strokeColor=#333333;strokeWidth=2;fontStyle=1;fontSize=11;" edge="1" parent="1" source="n14" target="n15"><mxGeometry relative="1" as="geometry"><Array as="points"><mxPoint x="930" y="730" /><mxPoint x="490" y="730" /><mxPoint x="490" y="900" /></Array></mxGeometry></mxCell>
        ...
        <mxCell id="e134" value="Belum (Panen Lagi)" style="edgeStyle=orthogonalEdgeStyle;rounded=1;html=1;strokeColor=#333333;strokeWidth=2;fontStyle=1;fontSize=11;" edge="1" parent="1" source="n32" target="n25"><mxGeometry relative="1" as="geometry"><Array as="points"><mxPoint x="760" y="1425" /></Array></mxGeometry></mxCell>

        <!-- UMUM EDGES -->
        <mxCell id="e135" value="Update Katalog Publik" style="edgeStyle=orthogonalEdgeStyle;rounded=1;html=1;strokeColor=#059669;strokeWidth=2;fontStyle=1;fontSize=11;" edge="1" parent="1" source="n31" target="u1"><mxGeometry relative="1" as="geometry"/></mxCell>
        <mxCell id="e136" value="" style="edgeStyle=orthogonalEdgeStyle;rounded=1;html=1;strokeColor=#d97706;strokeWidth=2;fontStyle=1;fontSize=11;" edge="1" parent="1" source="u1" target="u2"><mxGeometry relative="1" as="geometry"/></mxCell>
