        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl border border-slate-200/60 p-6 sm:p-8 shadow-sm">
                ...
                <div class="flex items-center space-x-2.5 pb-4 mb-6 border-b border-slate-100">
                    ...
                    <div>
                        <h3 class="text-base font-extrabold text-slate-800">Form Laporan Produksi Baru</h3>
                        <p class="text-xs text-slate-500">Catat berat dan kondisi panen jamur tiram hari ini.</p>
                    </div>
                </div>
