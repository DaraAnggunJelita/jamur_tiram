<x-app-layout>
 ...
 <input type="number" name="durasi_pengukusan" id="durasi_pengukusan" min="0" value="{{ old('durasi_pengukusan', $sterilisasi->durasi_pengukusan) }}" required class="block w-full rounded-xl border-[#E5E7EB]/60 bg-white py-2.5 shadow-sm focus:border-[#059669] focus:ring-[#059669]">
 ...
 <option value="Aman" {{ old('kondisi_air', $sterilisasi->kondisi_air) == 'Aman' ? 'selected' : '' }}>Aman</option>
 <option value="Menipis" {{ old('kondisi_air', $sterilisasi->kondisi_air) == 'Menipis' ? 'selected' : '' }}>Menipis</option>
 <option value="Habis" {{ old('kondisi_air', $sterilisasi->kondisi_air) == 'Habis' ? 'selected' : '' }}>Habis</option>
 </select>
 ...
 <option value="Stabil-Besar" {{ old('kestabilan_api', $sterilisasi->kestabilan_api) == 'Stabil-Besar' ? 'selected' : '' }}>Stabil-Besar</option>
 <option value="Mengecil" {{ old('kestabilan_api', $sterilisasi->kestabilan_api) == 'Mengecil' ? 'selected' : '' }}>Mengecil</option>
 <option value="Padam" {{ old('kestabilan_api', $sterilisasi->kestabilan_api) == 'Padam' ? 'selected' : '' }}>Padam</option>
 </select>
