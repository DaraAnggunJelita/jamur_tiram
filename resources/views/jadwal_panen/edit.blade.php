<x-app-layout>
 ...
 <div>
 <h3 class="text-base font-bold text-[#064E3B]">Perbarui Jadwal Estimasi</h3>
 <p class="text-xs text-[#6B7280] font-medium">Ubah perkiraan tanggal pemetikan jamur tiram.</p>
 </div>
 </div>
 ...
 class="block w-full rounded-xl border-[#E5E7EB]/60 bg-white shadow-2xs focus:border-[#059669] focus:ring-0 text-sm py-2.5 text-[#064E3B] placeholder-[#E5E7EB]/70 @error('catatan') border-[#F59E0B] focus:border-[#F59E0B] @enderror">{{ old('catatan', $jadwal->catatan) }}</textarea>
 @error('catatan')
 <p class="text-[#F59E0B] text-xs font-bold mt-1 font-sans">{{ $message }}</p>
 @enderror
 </div>
