...
<html lang="{{ str_replace('_','-', app()->getLocale()) }}">
 ...
 <span class="text-white font-bold text-xs">KUPS Harapan Asri</span>
 </div>

 <div class="relative z-10 my-auto">
 <h2 class="text-white text-3xl font-extrabold leading-[1.2]">
 ...
 <div class="relative z-10 text-[10px] text-white/40">
 ...
 <div class="flex items-center justify-center gap-4 text-[10px] font-bold text-slate-300 mt-4">
