<x-app-layout>
 ...
 <span class="ml-1 text-[#064E3B] md:ml-2">Tambah Baru</span>
 </div>
 </li>
 </ol>
 </nav>
 ...
 <svg class="w-5 h-5 text-[#059669]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/></svg>
 <span>Form Detail Produk</span>
 </h3>

 <form action="{{ route('admin.catalogs.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 font-sans">
 @csrf
 ...
 class="block w-full rounded-xl border-[#E5E7EB]/60 bg-white shadow-2xs focus:border-[#059669] focus:ring-[#059669] text-sm py-2.5 text-[#374151] font-medium placeholder-[#6B7280]/50" required>
 ...
 class="block w-full rounded-xl border-[#E5E7EB]/60 bg-white shadow-2xs focus:border-[#059669] focus:ring-[#059669] text-sm py-2.5 text-[#374151] font-medium placeholder-[#6B7280]/50" required>{{ old('description') }}</textarea>
 ...
 class="block w-full pl-9 rounded-xl border-[#E5E7EB]/60 bg-white focus:border-[#059669] focus:ring-[#059669] text-sm py-2.5 text-[#374151] font-bold placeholder-[#6B7280]/50" required>
 </div>
 ...
 {{-- Foto Produk --}}
 <div>
 <label class="block text-xs font-bold text-[#047857] mb-1.5">Foto Produk</label>
