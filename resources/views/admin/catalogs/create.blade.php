<x-app-layout>
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-slate-600 md:ml-2">Tambah Baru</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="bg-white shadow-sm rounded-2xl border border-slate-200/60 p-8">
                <h3 class="text-lg font-extrabold text-slate-800 pb-4 mb-6 border-b border-slate-100 flex items-center space-x-2">
                    <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/></svg>
                ...
                <form action="{{ route('admin.catalogs.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4" placeholder="Jelaskan keunggulan produk, ukuran kemasan, kebersihan, dll..."
                            class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm py-2.5" required>{{ old('description') }}</textarea>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5">Foto Produk</label>
    ...
    <script>
        // Preview handling/styling for file input if needed
