            ...
            <div class="bg-white overflow-hidden shadow-xs border border-[#E5E7EB]/60 rounded-2xl p-6 sm:p-8">
                ...
                <form method="POST" action="{{ route('admin.ews.settings.update') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="min_durasi_sterilisasi" class="block text-xs font-bold text-[#064E3B] uppercase tracking-wider mb-2">Minimum Durasi Sterilisasi (Jam)</label>
                            <div class="relative">
                                <input type="number" step="0.5" name="min_durasi_sterilisasi" id="min_durasi_sterilisasi" value="{{ $settings->min_durasi_sterilisasi }}" required class="block w-full rounded-xl border-[#E5E7EB] bg-[#F9FAFB] py-2.5 px-3.5 text-sm font-semibold text-[#064E3B] shadow-xs focus:bg-white focus:border-[#059669] focus:ring-[#059669]">
                            </div>
                            <p class="text-[11px] text-[#6B7280] mt-1.5 font-medium">Durasi pengukusan baglog di bawah angka ini akan ditandai berisiko.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-[#6B7280] mt-1.5 font-medium">Batas maksimum hari panen terhitung semenjak pinhead jamur muncul.</p>
                        </div>
                    </div>
