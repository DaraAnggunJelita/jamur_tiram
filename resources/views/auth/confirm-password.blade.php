...
<div class="w-full max-w-[360px] mx-auto flex flex-col justify-center px-4 py-6">
    ...
    <form method="POST" action="{{ route('password.confirm') }}" class="space-y-4">
        ...
        <div class="pt-2">
            <button type="submit" class="w-full flex items-center justify-center gap-2 bg-[#0d7844] hover:bg-[#0a5e35] text-white font-semibold py-2.5 px-4 rounded-xl shadow-md active:scale-[0.98] transition-all duration-200 text-xs tracking-wider uppercase font-sans font-sans">
